...
@section('content')
    ...
    <form method="post" action="{{ route('debitur.simpanakad', $debitur->id) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="row mb-3">
            ...
            <div class="col-lg-4 d-flex">
                <div class="card card-body flex-fill">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                            <input class="form-control @error('tglAkad') is-invalid @enderror" type="date"
                                value="{{ old('tglAkad') }}" id="tglAkad" name="tglAkad">
                            @error('tglAkad')
