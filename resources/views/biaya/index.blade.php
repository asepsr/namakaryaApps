    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <h4 class="page-title">Tabel Biaya</h4>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-lg">
            <div class="card bg-white m-b-30">
                <div class="card-body new-user">
                    <h5 class="header-title mb-4 mt-0">Data Biaya</h5>
                    {{-- @can('create cabang') --}}
...
@push('scripts')
    ...
    <script>
            ...
            $('#formAction').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        window.LaravelDataTables["biayadatatables-table"].ajax.reload()
                        $('#modalAction').find('.modal-dialog').html(response)
        ...
        $('#biayadatatables-table').on('click', '.action', function() {
            let data = $(this).data()
            let id = data.id
